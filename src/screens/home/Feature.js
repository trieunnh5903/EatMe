...
const Feature = () => {
  ...
  return (
    <View style={{flex: 1}}>
      <FlatList
        style={{flex: 1}}
        ItemSeparatorComponent={<View style={{height: SIZES.radius}}></View>}
          ...
          return (
            <TouchableOpacity style={[styles.container]}>
              ...
              <View style={{flex: 1, marginTop: SIZES.radius}}>
                ...
                <Text
                  numberOfLines={1}
                  style={[FONTS.subtitle2, {color: COLORS.darkGray2}]}>
                  {item.thumbnailUrl}
                </Text>
                <Text
                  numberOfLines={1}
              ...
              <View style={styles.icon}>
                ...
                />
                <Text style={{color: COLORS.darkGray2, ...FONTS.subtitle2}}>
