...
export const addItem = createAsyncThunk('cart/addItem', (item, { dispatch, getState }) => {
    dispatch(cartSlice.actions.addItem(item));
    dispatch(cartSlice.actions.calculateTotalCart());
});

export const updateItemQuantity = createAsyncThunk('cart/updateItemQuantity', (payload, { dispatch }) => {
    dispatch(cartSlice.actions.updateItemQuantity(payload));
    dispatch(cartSlice.actions.calculateTotalCart());
});

export const removeItem = createAsyncThunk('cart/removeItem', (itemIdToRemove, { dispatch }) => {
